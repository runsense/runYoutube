var F=F||{},F={player:null,vid:'*PLrwe0-1smC6zJ1CmdbhHnvLNqnb7tHqVo',d:true,b:{f:'',k:'',c:''},tbsv:[],ta:[],
...
$.each(t,function(){
		...
		inp.bind("click",function(){
			if(this.id=='pl'){
				this.id=this.value;
				this.value=F.player.getVideoData().title;
			}
			F.l(this.id);			
		});
           F.ta.push(inp);		  
...
change:function(e){var f=e.data;f==0?C.c0(f):f==1?C.c1(f):'';},
...
init:function(){$('.style').bind("click",function(){
